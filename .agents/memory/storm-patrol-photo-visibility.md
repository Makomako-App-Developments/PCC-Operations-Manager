...
Confirmed in the published apps on 2026-09-13: desktop before/after photos render, and Field Ops saved thumbnails render and delete via the red-X when editing a completed job.