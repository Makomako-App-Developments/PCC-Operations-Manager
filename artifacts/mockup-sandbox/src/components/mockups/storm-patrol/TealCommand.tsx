  ...
  return <div className="tc-page">
    <style>{`
      ...
      .tc-alert{padding:16px;border:1px solid rgba(255,151,57,.38);background:rgba(121,60,16,.35);border-radius:12px}.tc-alert h3{margin:0 0 11px;display:flex;align-items:center;gap:6px;color:#ffae4b;font-size:11px}.tc-alert textarea{display:block;resize:none;width:100%;height:58px;border-radius:4px;border:1px solid rgba(255,169,71,.3);background:#102f36;padding:8px;color:#f4ffff;outline:none;font-size:11px}.tc-alert textarea::placeholder{color:#719095}.tc-send{width:100%;margin-top:10px;border:1px solid rgba(255,191,107,.36);background:#c96c18;color:#fff;border-radius:4px;padding:8px;font-size:12px;font-weight:700;cursor:pointer}
       .tc-main{min-width:0}.tc-package{padding:20px;margin-bottom:18px;display:flex;flex-direction:column;min-height:calc(100vh - 118px)}.tc-package.collapsed{min-height:auto}.tc-package-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:20px}.tc-package-head button{border:1px solid var(--line);background:transparent;color:#b0d6d8;border-radius:4px;padding:6px 9px;cursor:pointer;font-size:10px}.tc-package h2,.tc-operations h2{margin:0;color:#edffff;font-size:16px;font-weight:650;display:flex;gap:10px;align-items:center}.tc-package h2 svg{color:#31d8df}.tc-controls{display:grid;grid-template-columns:1.05fr 1fr 1fr;gap:20px;margin:0 0 20px;align-items:end}.tc-controls label{color:#9bc2c5;font-size:11px}.tc-select{height:32px;margin-top:7px;border:1px solid var(--line);background:#0d303a;border-radius:3px;color:#eaffff;display:flex;align-items:center;justify-content:space-between;padding:0 10px;font-size:11px;cursor:pointer}.tc-select.placeholder{color:#79a1a5}.tc-publish{height:32px;border:1px solid rgba(59,222,226,.5);background:#16aeb8;color:white;border-radius:4px;display:flex;justify-content:center;align-items:center;gap:7px;font-size:11px;font-weight:700;cursor:pointer}.tc-publish:disabled{opacity:.45;cursor:not-allowed}
       .tc-asset-box{flex:1;min-height:450px;border:1px solid var(--line);border-radius:9px;overflow:hidden;background:#0b303a}.tc-toolbar{height:47px;padding:8px 11px;display:flex;align-items:center;gap:16px;background:rgba(103,212,211,.08);border-bottom:1px solid var(--line);color:#a4c8cb;font-size:11px}.tc-search{width:205px;height:27px;display:flex;align-items:center;gap:6px;padding:0 8px;background:#0b2832;border:1px solid var(--line);border-radius:3px}.tc-search svg{color:#73a2a6}.tc-search input{border:0;outline:0;background:transparent;color:#eaffff;width:100%;font-size:11px}.tc-search input::placeholder{color:#6e969a}.tc-toolbar span{margin-left:auto}.tc-toolbar b{color:#eaffff}.tc-toolbar button{border:0;background:transparent;color:#b0d6d8;font-size:10px;cursor:pointer}.tc-asset-content{display:flex;height:calc(100% - 47px)}.tc-list{width:40%;min-width:190px;overflow:auto;padding:7px;border-right:1px solid var(--line)}.tc-asset{display:flex;gap:9px;padding:8px;border:1px solid transparent;border-radius:6px;align-items:flex-start;font-size:11px;cursor:pointer}.tc-asset.selected{background:rgba(24,196,207,.18);border-color:rgba(75,226,227,.4)}.tc-asset input{accent-color:#20d3d7;margin:3px 0 0}.tc-asset b,.tc-asset span{display:block}.tc-asset b{font-weight:600}.tc-asset span{color:#79a4a8;font-size:10px;margin-top:2px}.tc-asset em{font-style:normal;font-size:8px;font-weight:800;color:#ff7777;background:rgba(239,68,68,.16);padding:3px 4px;border-radius:3px;margin-left:auto}.tc-map{position:relative;overflow:hidden;flex:1;background:#09262d;isolation:isolate}.tc-map:after{content:"";position:absolute;inset:-10%;background:radial-gradient(ellipse at 55% 40%,rgba(46,153,150,.32),transparent 45%),linear-gradient(145deg,transparent 42%,rgba(105,212,194,.25) 42.2%,transparent 43%),repeating-linear-gradient(132deg,transparent 0 28px,rgba(147,220,205,.12) 29px 30px,transparent 31px 60px);opacity:.9;z-index:-1}.tc-map-label{position:absolute;color:rgba(220,255,249,.36);font-size:12px;font-weight:700;letter-spacing:1px}.tc-porirua{left:51%;top:50%}.tc-request{transform:rotate(-47deg);top:35%;left:8%}.tc-road{position:absolute;height:2px;background:rgba(196,247,236,.4);transform:rotate(-48deg)}.tc-r1{width:280px;top:54%;left:12%}.tc-r2{width:250px;top:30%;left:45%}.tc-r3{width:170px;top:73%;left:31%}.tc-point{position:absolute;width:7px;height:7px;border-radius:100%;border:2px solid #d4fff3;background:#09262d}.tc-p1{left:45%;top:30%}.tc-p2{left:71%;top:61%}.tc-p3{left:34%;top:74%}.tc-zoom{position:absolute;top:10px;left:10px;display:flex;flex-direction:column;box-shadow:0 1px 3px #032026}.tc-zoom button{width:25px;height:25px;border:0;background:#dffcf4;color:#16424a;font-size:19px;line-height:1;cursor:pointer}.tc-zoom button+button{border-top:1px solid #86b9b5}
