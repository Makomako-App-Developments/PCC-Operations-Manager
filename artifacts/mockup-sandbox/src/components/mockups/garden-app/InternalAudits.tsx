...
import {
  ...
  Clock, ChevronRight, Search, Filter, MapPin, User,
  AlertTriangle, X, Shuffle
} from "lucide-react";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-2xl shadow-2xl w-[540px] max-h-[80vh] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {step === "type" && (
            <div className="space-y-3">
              ...
              <button
                onClick={() => { setAuditType("completed-works"); setStep("site"); }}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 inline-flex items-center gap-1.5 text-[11px] font-medium px-2 py-0.5 rounded-full bg-[#00AECD15] text-[#00AECD]">
                      ...
                      {SITES_IN_WINDOW.length} sites in audit window
                    </div>
                  </div>
              ...
              <button
                onClick={() => { setAuditType("outcomes"); setStep("site"); }}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 inline-flex items-center gap-1.5 text-[11px] font-medium px-2 py-0.5 rounded-full bg-purple-50 text-purple-600">
                      ...
                      All {ALL_SITES.length}+ sites available
                    </div>
                  </div>
          ...
          {step === "site" && auditType === "completed-works" && (
            <div>
              <p className="text-sm text-gray-500 mb-4">
                Showing sites serviced within the last 4 days. Only these are eligible for a Completed Works audit.
              </p>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className={`text-[11px] font-semibold mt-0.5 ${s.daysAgo >= 3 ? "text-amber-600" : "text-gray-500"}`}>
                          Day {s.daysAgo} of 4
                        </p>
                      </div>
                    </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="flex-1 relative">
                  ...
                  <input
                    className="w-full pl-8 pr-3 py-2 text-sm border border-gray-200 rounded-lg outline-none focus:border-[#00AECD]"
        ...
        <div className="px-6 py-4 border-t flex items-center justify-between">
          {step === "site" ? (
            <button onClick={() => setStep("type")} className="text-sm text-gray-400 hover:text-gray-600 transition-colors">← Back</button>
          ) : (
            <div />
          )}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="flex items-center justify-between px-5 pt-4 border-b">
              <div className="flex gap-1">
                <button
                  onClick={() => setTab("completed-works")}
                ...
                >
                  ...
                  Completed Works
                  <span className={`text-[10px] px-1.5 py-0.5 rounded-full font-semibold ${tab === "completed-works" ? "bg-[#00AECD15] text-[#00AECD]" : "bg-gray-100 text-gray-400"}`}>
                    {cwAudits.length}
                  </span>
                </button>
                <button
                ...
                >
                  ...
                  Outcomes Based
                  <span className={`text-[10px] px-1.5 py-0.5 rounded-full font-semibold ${tab === "outcomes" ? "bg-purple-50 text-purple-600" : "bg-gray-100 text-gray-400"}`}>
                    {obAudits.length}
                  </span>
                </button>
              </div>
            ...
            {tab === "completed-works" && (
              <div className="px-3 py-2 bg-amber-50 border-b border-amber-100 flex items-center gap-2">
                ...
                <span className="text-xs text-amber-700 font-medium">{windowPending} sites currently in the 4-day audit window — <button className="underline" onClick={() => setShowModal(true)}>start a new audit</button></span>
              </div>
            )}
            {tab === "outcomes" && (
              <div className="px-3 py-2 bg-purple-50 border-b border-purple-100 flex items-center gap-2">
                ...
                <span className="text-xs text-purple-700 font-medium">Random spot-checks — any site, any time. Low pass rates indicate maintenance frequency needs review.</span>
              </div>
            )}
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-50">
                  ...
                  {tab === "completed-works" && (
                    <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Serviced</th>
                  )}
                  <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Audited</th>
                  {tab === "completed-works" && (
                    <th className="text-left px-4 py-3 text-[11px] font-semibold text-gray-400 uppercase tracking-wider">Window</th>
                  )}
              ...
              <tbody>
                {filtered.map(a => (
                  <tr key={a.id} className="border-b border-gray-50 hover:bg-gray-50/60 transition-colors">
                    ...
                    {tab === "completed-works" && (
                      <td className="px-4 py-3.5 text-xs text-gray-500">{a.servicedDate}</td>
                    )}
                    ...
                    <td className="px-4 py-3.5">
                      <ScoreBar score={a.score} result={a.result} />
                    </td>
                    <td className="px-4 py-3.5">
